...
public class ShippingCosts {
    ...
    public static void main(String[] args) {
        ...
        double itemWeight = Double.parseDouble(JOptionPane.showInputDialog("What is the weight of your package?"));
        int milesShipped = Integer.parseInt(JOptionPane.showInputDialog("How many miles will it be shipped?"));
        double shippingRate;
        double cost;
        ...
        JOptionPane.showMessageDialog(null, "Your cost is: " + cost);
